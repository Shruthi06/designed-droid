...
public class MainActivity extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		final String[] phnoe_num={"77777777","888888888","999999999","444444444","555555555","66666666"};
		...
		phone_number.setOnItemClickListener(new OnItemClickListener()
		{
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,long arg3) 
			{
				...
				case 0: Intent intent=new Intent(Intent.ACTION_CALL);
						intent.setData(Uri.parse("tel:"+ phnoe_num[position]));
						startActivity(intent);
				break;
				
				case 1:Intent intent1=new Intent(Intent.ACTION_CALL);
						intent1.setData(Uri.parse("tel:"+phnoe_num[position]));
						startActivity(intent1);
				break;
				case 2:Intent intent2=new Intent(Intent.ACTION_CALL);
						intent2.setData(Uri.parse("tel:"+phnoe_num[position]));
						startActivity(intent2);
				break;
				case 3: Intent intent3=new Intent(Intent.ACTION_CALL);
						intent3.setData(Uri.parse("tel:"+phnoe_num[position]));
						startActivity(intent3);
				break;
				case 4:Intent intent4=new Intent(Intent.ACTION_CALL);
						intent4.setData(Uri.parse("tel:"+phnoe_num[position]));
						startActivity(intent4);
				break;
				case 5:Intent intent5=new Intent(Intent.ACTION_CALL);
						intent5.setData(Uri.parse("tel:"+phnoe_num[position]));
